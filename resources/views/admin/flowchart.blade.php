...
<body>
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="row">
        <div class="col-sm-4">
          <p class ="student">STUDENT NAME HERE</br>
           STUDENT NUMBER HERE</br>
            STUDENT SY BATCH HERE</br>
          ...
          <div class="text-center">
           <div class="unitbox"> <div class="number"> 1 </div></div>
            ...
            @foreach ($subjectinfo as $subject) 
              ...
              <div class="gap"><a href="" class="passed" data-toggle="modal" data-target="#myModal{{$subject->SubjectsID}}">{{$subject->subjectcode}}<br>{{$subject->units}}.0</br></a></div>
              
              @include('layouts.admincontent')
    ...
    <div class="row">
      ...
      <div class="col-md-3 mx-auto">
        ...
        <ul class="list-unstyled">
          <li>
            <p class ="information">Total Number of Academic Units: 80.0</p>
          </li>
          <li>
            <p class ="information">Total Number of Non-Academic Units: 9.0</p>
          </li>
          <li>
            <p class ="information">Total Number of Units Earned: 89.0</p>
          </li>
          <li>
            <p class ="information">Out Of: 180.0</p>
          </li>
          <li>
            <p class ="information">Remaining Units: 91.0</p>
          </li>
        </ul>
      </div>
      <!-- Grid column -->
